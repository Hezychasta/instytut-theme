...
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
        <div class="create-note">
            ...
            <span class="submit-note btn btn--blue btn--large">Create Note</span>
        ...
        <ul class="min-list link-list" id="my-notes">
            ...
            while ($userNotes->have_posts()) {
                ...
                <li data-id="<?php the_ID(); ?>">
                    <input readonly class="note-title-field" value="<?php echo str_replace('Private: ', '', esc_attr(get_the_title())); ?>" data-id="<?php the_ID(); ?>" />
